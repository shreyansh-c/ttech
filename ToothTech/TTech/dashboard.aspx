<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="ToothTech.TTech.dashboard" %>
...
<html lang="en">
	...
	<head><base href="#">
		...
		<link href="/TTech/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		<link href="/TTech/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="/TTech/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="/TTech/assets/css/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div class="menu-item">
											<a class="menu-link" href="../../demo8/dist/dashboards/ecommerce.html">
												...
												<span class="menu-title">Patient Assesment</span>
											</a>
										</div>
										<div class="menu-item">
											<a class="menu-link" href="../../demo8/dist/dashboards/store-analytics.html">
												...
												<span class="menu-title">Refer to department</span>
											</a>
										</div>
										<div class="menu-item">
										...
										<div class="menu-item">
											<a class="menu-link" href="../../demo8/dist/dashboards/delivery.html">
												...
												<span class="menu-title">Next visit/Finalize</span>
											</a>
										</div>
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="header-brand">
							...
							<a href="../../demo8/dist/index.html">
								<img alt="Logo" src="/TTech/assets/logos/logo1.png" class="h-40px h-lg-40px" />
							</a>
							<!--end::Logo-->
						...
						<div class="toolbar d-flex align-items-stretch">
							...
							<div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">Subharti Dental College</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
		...
		<script src="/TTech/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
		<script src="/TTech/assets/plugins/custom/datatables/datatables.bundle.js"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="/TTech/assets/js/widgets.bundle.js"></script>
		<script src="/TTech/assets/js/custom/widgets.js"></script>
		<script src="/TTech/assets/js/custom/apps/chat/chat.js"></script>
		<script src="/TTech/assets/js/custom/utilities/modals/users-search.js"></script>
